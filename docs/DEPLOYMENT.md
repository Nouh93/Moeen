...
|---|---|---|
| سيرفر | VPS بذاكرة 4GB+ (أوبنتو 22+) في الإمارات | أقرب نقطة موثوقة لليمن (القسم 22.3.1) — مثل Hetzner/DO/Vultr مع مراعاة الموقع |
...
1. **حساب المدير**: عدّل رقم مدير المنصة في `apps/api/prisma/seed.ts` قبل البذر (الافتراضي `700000001`) — لوحة الإدارة على `/admin`.
