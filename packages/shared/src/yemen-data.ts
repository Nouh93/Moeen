...
export const YEMEN_GOVERNORATES: GovernorateData[] = [
  ...
  { code: "TAI", nameAr: "تعز", districts: [] },
  { code: "HOD", nameAr: "الحديدة", districts: [] },
  { code: "IBB", nameAr: "إب", districts: [] },
  { code: "DHA", nameAr: "ذمار", districts: [] },
  ...
  { code: "MAR", nameAr: "مأرب", districts: [] },
  ...
  { code: "HDR", nameAr: "حضرموت", districts: [] },
